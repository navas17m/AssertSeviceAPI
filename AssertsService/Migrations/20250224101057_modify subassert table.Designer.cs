...
namespace AssertsService.Migrations
{
    ...
    [Migration("20250224101057_modify subassert table")]
    partial class modifysubasserttable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssertsService.Models.MasterAssert", b =>
                {
                    b.Property<int>("MasterAssertId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MasterAssertId"));

                    b.Property<string>("MasterAssertName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("MasterAssertId");

                    b.ToTable("MasterAsserts");
                });
            ...
            modelBuilder.Entity("AssertsService.Models.SubAsset", b =>
                {
                    b.Property<int>("SubAssetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SubAssetId"));
